...
export default function FeaturesPage() {
  const categories = [
    ...
    },
    {
      ...
      description: 'Intelligence artificielle pour optimiser votre workflow',
      icon: Sparkles,
      color: 'from-orange-500 to-red-500',
      features: [
        {
          icon: Sparkles,
          name: 'Détection Auto Format',
          description: 'L\'IA suggère automatiquement le format optimal pour votre usage',
        },
        {
          icon: Zap,
          name: 'Amélioration Qualité',
          description: 'Upscaling images, nettoyage PDF, amélioration audio automatique',
        },
        {
          icon: FileSearch,
          name: 'OCR Intelligent',
          description: 'Reconnaissance de texte dans 30+ langues avec mise en forme',
        },
        {
          icon: Workflow,
          name: 'Workflows Visuels',
          description: 'Créez des pipelines de conversion automatisés par glisser-déposer',
        },
      ],
    },
    {
